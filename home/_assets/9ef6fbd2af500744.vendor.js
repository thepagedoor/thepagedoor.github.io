"use strict";
(globalThis.webpackChunk_canva_web = globalThis.webpackChunk_canva_web || []).push([[59880], {
    19779: (e, t, n) => {
        let r;
        n.r(t),
        n.d(t, {
        ...
        function b(e, t) {
            return e >>>= 0,
            _.decode(c().subarray(e, e + t))
        }
        function o(e) {
            const t = r.__externref_table_alloc();
            return r.__wbindgen_export_2.set(t, e),
            t
        }
        function a(e, t) {
            try {
        ...
        function d(e, t, n) {
            if (void 0 === n) {
                const n = s.encode(e)
                  , r = t(n.length, 1) >>> 0;
                return c().subarray(r, r + n.length).set(n),
                u = n.length,
                r
            }
            let r = e.length
        ...
        let l = null;
        function h() {
            return (null === l || !0 === l.buffer.detached || void 0 === l.buffer.detached && l.buffer !== r.memory.buffer) && (l = new DataView(r.memory.buffer)),
            l
        }
            ...
            const i = {
              ...
              , c = (...e) => {
                ...
                try {
                    ...
                    0 == --i.cnt && (r.__wbindgen_export_6.get(i.dtor)(i.a, i.b),
                    i.a = 0,
                    p.unregister(i))
                }
            }
            ...
            const i = {
              ...
              , c = (...e) => {
                ...
                try {
                    ...
                    0 == --i.cnt ? (r.__wbindgen_export_6.get(i.dtor)(t, i.b),
                    p.unregister(i)) : i.a = t
                }
            }
            ;
            return c.original = i,
        ...
        class C {
            ...
            render_webgl(e, t) {
                A(e, X),
                r.gltfrendererinternal_render_webgl(this.__wbg_ptr, e.__wbg_ptr, t)
            }
            dispose_webgl(e) {
                const t = this.__destroy_into_raw();
                A(e, X),
                r.gltfrendererinternal_dispose_webgl(t, e.__wbg_ptr)
            }
        }
        ...
        let O = class {
            ...
            constructor(e, ...t) {
                ...
                M.register(this, this.__wbg_ptr, this),
                this
            }
            id() {
                return r.binarytexture_id(this.__wbg_ptr)
        ...
        async function Z(e) {
            ...
            void 0 === e && (e = new URL("" + new URL(n(159448),n.b).href,"file:///mnt/engflow/worker/work/5/exec/bazel-out/k8-opt-exec-ST-781bf821b7a5/bin/web/src/pages/export_website/webpack_cli_page_/webpack_cli_page.runfiles/_main/node_modules/.aspect_rules_js/@canva+fragl-rs@0.4.5/node_modules/@canva/fragl-rs/dist/fragl.js"));
            const t = Y();
            ("string" == typeof e || "function" == typeof Request && e instanceof Request || "function" == typeof URL && e instanceof URL) && (e = fetch(e));
            const {instance: _, module: c} = await async function(e, t) {
        ...
        class ge {
            ...
            createBackend() {
                const e = this.create();
                return "onContextLost"in e && (e.onContextLost = e => this.onContextLost?.(e)),
                e
            }
            load(e) {
        ...
        function fe(e, t) {
            ...
            if (n.removeEventListener("webglcontextcreationerror", _),
            !c)
                throw new Error(`A WebGL context could not be created. Reason: ${r}`);
            return new X(c,{
                ...t,
                onDispose: () => {
                    n.remove()
        ...
        $.prototype.resourceType = "shader",
        P.prototype.resourceType = "buffer",
        D.prototype.resourceType = "elements",
        W.prototype.resourceType = "texture",
        z.prototype.resourceType = "texture",
...
//# sourceMappingURL=sourcemaps/9ef6fbd2af500744.vendor.js.map
